				...
				<s:iterator value="listProduits">
					<tr>
						...
						<td>
							...
							<a href="toProduitplusdinf?idProduit=${id}"><s:property value="getText('global.plusdinf')"/></a><br/>
							<a href="toaffectercategorie?idProduit=${id}"><s:property value="getText('global.affectcat')"/></a>		
						</td>
					</tr>
				</s:iterator>
			</tbody>
